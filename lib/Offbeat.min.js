...
k.type=this.instrument;k.frequency.value=n;k.start(0);k.stop(this.context.currentTime+m);k.onended=function(){h<l.notesParsed.length-1?(h+=1,l.generate_audio(h)):l.ended()}},calculate_time:function(h){return h*this.beatsPerMeasure/(this.tempo/60)},layer:function(h){var l={tempo:60,timeSig:"4/4",instrument:"sine",notes:""};if(h&&"object"===typeof h)for(var k in h)if(l.hasOwnProperty(k)&&typeof l[k]===typeof h[k])l[k]=h[k];else throw Error('Property "'+k+'" is invalid');h=Object.assign(Object.create(this),
l);h.beatsPerMeasure=parseInt(h.timeSig,10);h.notesParsed=this.parse_notes(h.notes);h.context=new (window.AudioContext||window.webkitAudioContext);h.isLoop=!1;return h},play:function(){if(""===this.notes)throw Error('Property "notes" is invalid');this.generate_audio(0)},playReverse:function(){this.notesParsed.reverse();this.play()},playLoop:function(){this.isLoop=!0;this.play()},playReverseLoop:function(){this.isLoop=!0;this.playReverse()},stop:function(){this.isLoop=!1;this.ended()},time:function(){var h=
this;if(""===this.notes)return 0;var l=0;this.notesParsed.forEach(function(k){l+=h.calculate_time(duration[k[0]])});return l},ended:function(){var h=this;this.context.close().then(function(){h.context=new (window.AudioContext||window.webkitAudioContext);h.isLoop?h.play():h.notesParsed=h.parse_notes(h.notes)})}};module.exports=Offbeat;
