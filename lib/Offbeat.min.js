...
l.type=this.instrument;l.frequency.value=n;l.start(0);l.stop(this.context.currentTime+m);l.onended=function(){h<k.notesParsed.length-1?k.generate_audio(++h):k.ended()}},calculate_time:function(h){return h*this.beatsPerMeasure*60/this.tempo},layer:function(h){var k={tempo:60,timeSig:"4/4",instrument:"sine",notes:""};if("object"===typeof h)for(var l in h)if(typeof k[l]===typeof h[l])k[l]=h[l];else throw Error('Property "'+l+'" is undefined');h=Object.assign(Object.create(this),k);h.beatsPerMeasure=
parseInt(h.timeSig,10);h.notesParsed=this.parse_notes(h.notes);h.context=new (window.AudioContext||window.webkitAudioContext);h.isLoop=!1;return h},update:function(h){if("object"===typeof h)for(var k in h)if(typeof this[k]===typeof h[k])this[k]=h[k];else throw Error('Property "'+k+'" is undefined');this.beatsPerMeasure=parseInt(this.timeSig,10);this.notesParsed=this.parse_notes(this.notes);return this},play:function(){if(this.notes)this.generate_audio(0);else throw Error('Property "notes" is invalid');
},playReverse:function(){this.notesParsed.reverse();this.play()},playLoop:function(){this.isLoop=!0;this.play()},playReverseLoop:function(){this.isLoop=!0;this.playReverse()},stop:function(){this.isLoop=!1;this.ended()},time:function(){var h=this;if(!this.notes)return 0;var k=0;this.notesParsed.forEach(function(l){k+=h.calculate_time(duration[l[0]])});return k},ended:function(){var h=this;this.context.close().then(function(){h.context=new (window.AudioContext||window.webkitAudioContext);h.isLoop?
h.play():h.notesParsed=h.parse_notes(h.notes)})}};module.exports=Offbeat;
