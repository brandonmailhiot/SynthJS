...
m.frequency.value=p;m.start(0);m.stop(h.currentTime+n);m.onended=function(){k<l.notesParsed.length-1&&!l.isStopped?(k+=1,l.generate_audio(h,k)):h.close()}},calculate_time:function(h){return h*this.beatsPerMeasure/(this.tempo/60)},layer:function(h){var k={tempo:60,timeSig:"4/4",instrument:"sine",notes:""};if(h&&"object"===typeof h)for(var l in h)if(k.hasOwnProperty(l)&&typeof k[l]===typeof h[l])k[l]=h[l];else throw'Property "'+l+'" is invalid';h=Object.assign(Object.create(this),k);h.beatsPerMeasure=
parseInt(h.timeSig,10);h.notesParsed=this.parse_notes(h.notes);return h},play:function(){if(""===this.notes)throw'Property "notes" is invalid';var h=new (window.AudioContext||window.webkitAudioContext);this.isStopped=!1;this.generate_audio(h,0)},playReverse:function(){var h=this;this.notesParsed.reverse();this.play();setTimeout(function(){h.notesParsed.reverse()},1E3*this.time())},stop:function(){this.isStopped=!0},time:function(){var h=this;if(""===this.notes)return 0;var k=0;this.notesParsed.forEach(function(l){k+=
h.calculate_time(duration[l[0]])});return k}};module.exports=Offbeat;
