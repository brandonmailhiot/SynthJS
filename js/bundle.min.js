...
$("#harrypotter .composition").text("e b3,\ne-dot e4, s g4, e f#4,\nq e4, e b4,\nq-dot a4,\n\nq-dot f#4,\ne-dot e4, s g4, e f#4,\nq d#4, e f4,\nq-dot b3\n");$("#starwars .time").html("<strong>Time:</strong> "+a.time().toFixed(2)+" seconds");$("#ghostbusters .time").html("<strong>Time:</strong> "+b.time().toFixed(2)+" seconds");$("#harrypotter .time").html("<strong>Time:</strong> "+harrypotter.time().toFixed(2)+" seconds");$("#try-it .play-btn").click(function(){f().play()});$("#try-it .playLoo-btn").click(function(){f().playLoop()});
...
e=f[this.notesParsed[a][1]];c.connect(this.context.destination);c.type=this.instrument;c.frequency.value=e;c.start(0);c.stop(this.context.currentTime+d);c.onended=function(){a<b.notesParsed.length-1&&!b.isStopped?(a+=1,b.generate_audio(a)):b.normalize()}},calculate_time:function(a){return a*this.beatsPerMeasure/(this.tempo/60)},layer:function(a){var b={tempo:60,timeSig:"4/4",instrument:"sine",notes:""};if(a&&"object"===typeof a)for(var c in a)if(b.hasOwnProperty(c)&&typeof b[c]===typeof a[c])b[c]=
a[c];else throw Error('Property "'+c+'" is invalid');a=Object.assign(Object.create(this),b);a.beatsPerMeasure=parseInt(a.timeSig,10);a.notesParsed=this.parse_notes(a.notes);a.context=new (window.AudioContext||window.webkitAudioContext);a.isStopped=!1;a.isLoop=!1;return a},play:function(){if(""===this.notes)throw Error('Property "notes" is invalid');this.generate_audio(0)},playReverse:function(){this.notesParsed.reverse();this.play()},playLoop:function(){this.isLoop=!0;this.play()},playReverseLoop:function(){this.isLoop=
!0;this.playReverse()},stop:function(){this.isStopped=!0;this.isLoop=!1},time:function(){var a=this;if(""===this.notes)return 0;var b=0;this.notesParsed.forEach(function(c){b+=a.calculate_time(g[c[0]])});return b},normalize:function(){var a=this;this.context.close().then(function(){a.isLoop?(a.context=new (window.AudioContext||window.webkitAudioContext),a.isStopped=!1,a.play()):(a.context=new (window.AudioContext||window.webkitAudioContext),a.isStopped=!1,a.notesParsed=a.parse_notes(a.notes))})}}},
{}]},{},[1]);
